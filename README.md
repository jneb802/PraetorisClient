...
- Transfers ship network ownership to the local player after rudder control is granted, including password-protected ships. Rejected requests do not transfer ownership. Opening the ship chest retains the game's existing ownership behavior.
