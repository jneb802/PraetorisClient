...
namespace EpicLootLeslieAlphaTest.src
{
    public static class MagicEffects
    {
        public static void Init()
        {
            ...
            ancestralSlam.Requirements.AllowedRarities.Add(ItemRarity.Epic, ItemRarity.Legendary, ItemRarity.Mythic, ItemRarity.Ancient);
            ancestralSlam.SelectionWeight = 1f;
            ...
            glancingBlows.Requirements.AllowedItemTypes.Add("Bucklers", "RoundShields", "TowerShields", "OneHandedWeapon", "TwoHandedWeapon"); //
            glancingBlows.Requirements.ItemHasBlockPower = true;
            glancingBlows.Requirements.AllowedRarities.Add(ItemRarity.Magic, ItemRarity.Rare, ItemRarity.Epic, ItemRarity.Legendary, ItemRarity.Mythic, ItemRarity.Ancient);
            ...
            glancingBlows.ValuesPerRarity.Ancient = new ValueDef(1, 1, 1);
            glancingBlows.SelectionWeight = 5f;
            ...
            retaliation.Requirements.ItemHasBlockPower = true; // not catching items with block power appears on all pieces
            retaliation.Requirements.AllowedRarities.Add(ItemRarity.Magic, ItemRarity.Rare, ItemRarity.Epic, ItemRarity.Legendary, ItemRarity.Mythic, ItemRarity.Ancient);
            ...
            retaliation.ValuesPerRarity.Ancient = new ValueDef(6, 6, 1);
            retaliation.SelectionWeight = 2f;
            ...
            infusion.Requirements.AllowedRarities.Add(ItemRarity.Magic, ItemRarity.Rare, ItemRarity.Epic, ItemRarity.Legendary, ItemRarity.Mythic, ItemRarity.Ancient);
            ...
            infusion.ValuesPerRarity.Ancient = new ValueDef(7, 14, 1);
            infusion.SelectionWeight = 2f;
            ...
            whirlwind.Requirements.AllowedRarities.Add(ItemRarity.Epic, ItemRarity.Legendary, ItemRarity.Mythic, ItemRarity.Ancient);
            whirlwind.SelectionWeight = 1f;
            whirlwind.Register();
            ...
            onslaught.Requirements.AllowedRarities.Add(ItemRarity.Magic, ItemRarity.Rare, ItemRarity.Epic, ItemRarity.Legendary, ItemRarity.Mythic, ItemRarity.Ancient);
            onslaught.ValuesPerRarity.Magic.Set(.5f, 1f, .1f);
            onslaught.ValuesPerRarity.Rare = new ValueDef(.5f, 1.5f, .1f);
            onslaught.ValuesPerRarity.Epic = new ValueDef(1f, 2f, .1f);
            onslaught.ValuesPerRarity.Legendary = new ValueDef(1.5f, 2.5f, .1f);
            onslaught.ValuesPerRarity.Mythic = new ValueDef(2f, 3f, .1f);
            onslaught.ValuesPerRarity.Ancient = new ValueDef(2f, 3f, .1f);
            onslaught.SelectionWeight = 1f;
            onslaught.Register();
            ...
            //perfectStrike.Requirements.AllowedSkillTypes.Add(Skills.SkillType.Axes, Skills.SkillType.Swords);
