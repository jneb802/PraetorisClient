...
namespace EpicLootLeslieAlphaTest.src.StatusEffects
{
    public class SE_PoisonInfused : SE_Stats
    {
        ...
        private float infusedPoisonDamage = 0f;
        ...
        public override void Setup(Character character)
        {
            ...
            m_icon = ObjectDB.instance.GetItemPrefab("SwordNiedhoggNature")?.GetComponent<ItemDrop>()?.m_itemData.m_shared.m_icons[0];
            m_name = "Poison Infused";
            m_ttl = 120f;
        ...
        private void CreateVFX()
        {
            ...
            {
                m_vfxInstance = Object.Instantiate(InfusionVFX.PoisonInfusionVFX, vis.m_rightHand);
                m_vfxInstance.SetActive(true);
            }
            else
            {
                m_vfxInstance = Object.Instantiate(InfusionVFX.PoisonInfusionVFX, vis.m_rightHand);
                m_vfxInstance2 = Object.Instantiate(InfusionVFX.PoisonInfusionVFX, vis.m_leftHand);
                m_vfxInstance.SetActive(true);
